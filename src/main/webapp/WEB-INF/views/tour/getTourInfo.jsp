...
<style type="text/css">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b6bfd89225857a68f67bfb6b9951ea6b">
	</script>	
	<script type="text/javascript">
		
		$(function(){
			$.getJSON('http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailCommon?'+
					'ServiceKey=qBsyMq3ToLf3W5Xkt2QiSqcdwM45nODwIFkH4pYnWWUwhjD9NliJ%2BtEKpHcOgPg%2FQZ0UevFz1k%2FKrobLajTcwQ%3D%3D'+
