	...
	<div align="center" id="wrapper">
			...
			<table>
				<tr>
					...
					<td><input type="hidden" name="seq" value="${getQnaDetail.seq }">${getQnaDetail.seq }</td>
				</tr>
				<tr>
					<td class="category">제목</td>
					<td><input type="text" name="qnaSubject" id="inputTitle" value="${getQnaDetail.qnaSubject }"></td>
				</tr>
				<tr>
					<td class="category">작성자</td>
					<td>${getQnaDetail.qnaWriter }</td>
				</tr>
				<tr>
					<td class="category">내용</td>
					<td><textarea name="qnaContent">${getQnaDetail.qnaContent }</textarea></td>
				</tr>
				<tr>
					<td class="category">게시일</td>
					<td>${getQnaDetail.qnaDate }</td>
				</tr>
				<tr>
					<td colspan="2">
						<div id="button">
							<input type="submit" value="문의 수정" id="submitButton">
						</div>
					</td>
				</tr>
			</table>
