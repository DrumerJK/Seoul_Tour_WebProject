...
<body>
	...
	<div align="center" id="wrapper">
		<table>
			...
			<tr>
				<td id="idList"><a href="getMemberDetail.me?id=${user.id}">${user.id}</a></td>
				<td id="nameList">${user.name}</td>
				<td id="emailList">${user.email}</td>
				<td id="dateList">${user.birthDate}</td>
			</tr>
			</c:forEach>
		</table>
	</div>
