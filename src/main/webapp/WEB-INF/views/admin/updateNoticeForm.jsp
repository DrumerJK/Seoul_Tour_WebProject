			...
			<form action="updateNotice.do" method="post">
				<table>
					<tr>
						...
						<td align="left">
							<input type="hidden" name="seq" value="${noticeDetail.seq}">
							<input type="text" name="title" id="inputTitle" value="${noticeDetail.title}">
						</td>
					</tr>
					<tr>
						<td align="left" ><div class="category">내용</div></td>
						<td align="left"><textarea rows="15" cols="100" name="content">${noticeDetail.content}</textarea></td>
					</tr>
					<tr>
						<td colspan="2" align="right"><input type="submit" value="공지사항 수정" id="submitButton"
							onclick="alert('글 수정이 완료되었습니다.')">
						</td>
					</tr>
				</table>
			</form>
